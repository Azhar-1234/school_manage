        ...
        <div style="border: solid 2px; padding: 7px">
          <div class="row">
            <div style="float: right;" class="text-center">
              <img src="{{url('public/backend/images/logo.jfif')}}" style="width: 120px;height: 120px;float: right;">
            </div>
            <div class="col-md-2"></div>
            <div class="col-md-4 text-center" style="float: left;">
              <h4><strong>Darut Tawheed Madaniah</strong></h4>
          ...
          <div class="row">
            <div class="col-md-6">
                <table border="1" width="100%" cellpadding="9" cellspacing="2">
                  @php 
                  $assign_student = App\Models\Backend\Student\AssignStudent::where('year_id',$allMarks[0]->year_id)->where('class_id',$allMarks[0]->class_id)->first();
                  @endphp
                  <tr>
                  ...
                  <tr>
                   ...
                   @foreach($allGrades as $mark)
                    <tr>
                      ...
                      <td>
                        {{number_format((float)$mark->grade_point,2) }} - {{($mark->grade_point == 5)? (number_format( (float) $mark->grade_point,2):(number_format ((float)$mark->grade_point+1,2)}} - (float)0.01)}}
                      </td>
                    </tr>
                   @endforeach
                </thead>
              ...
              <table border="1" width="100%" cellpadding="1" cellspacing="1">
                ...
                <tbody>
                  ...
                  @php
                    ...
                    $total_subject = App\Models\Backend\StudentMarks::where('year_id',$mark->year_id)->where('class_id',$mark->class_id)->where('exam_type_id',$mark->exam_type_id)->where('student_id',$mark->student_id)->get()->count;
                  @endphp
                  <tr>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <hr style="border: solid 1px;width: 60%;color: #000"> 
              <div class="text-center">Parents/Gardian
            </div>
            <div class="col-md-4">
              <hr style="border: solid 1px;width: 60%;color: #000"> 
              <div class="text-center">Principal/Headmaster
            </div>
            </div>
          </div>
        </div>
