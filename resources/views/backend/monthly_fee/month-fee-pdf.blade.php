...
<body>
	<div class="container">
		<div class="row" id="myForm" enctype="multipart/form-data" >
			...
			<div class="col-md-12 text-center">
				<h3 style="font-weight: bold;padding-top: -10px;padding-bottom: 10px">Student Monthly Fee</h3>
			</div>
			<div class="col-md-12">
				@php 
					 $registrationfee = App\Models\BackEnd\FeeAmount::where('fee_category_id','2')->where('class_id',$details->class_id)->first();
