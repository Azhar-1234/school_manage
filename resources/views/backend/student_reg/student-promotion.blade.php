...
<div class="card col-md-10 m-3 pt-3">
    <div class="card-header">
        @if(isset($editData))
        <strong>Promotion</strong> Student 
        @else
     ...
     <form action="{{route('update-promotion',$editData->student_id)}}" method="post" id="myForm" enctype="multipart/form-data" class="">
       	@csrf
   		    ...
   		    <div class="card-body card-block">
                <div class="form-row">
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" name="name" value="{{@$editData['student']['name']}}" id="exampleInputName2"  required="" class="form-control form-control-sm">
                  ...
                  <div class="form-group col-md-4">
                     <image id="showImage"  src="{{url(!empty($editData['student']['image']))?url('public/upload/student_images/'.$editData['student']['image']):('public/upload/no_image.png')}}" style="height:160px;width:150px;border:1px solid #000">
                  </div>
           </div>
      		<div class="card-footer">
        	  	<button type="submit" class="btn btn-primary btn-sm"><i class="fa fa-dot-circle-o"></i> {{(@$editData?'Update':'Promotion')}} 
              </button> 
