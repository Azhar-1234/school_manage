...
class GradeController extends Controller
{
    public function view(){
    	...
    	return view('backend.marks.view-marks-grade',$data);
    }
    public function add(){
    ...
    public function store(Request $request){
    	...
    	$data->save();
    	return redirect()->route('view-marks-grade')->with('success','data successfully saved');
    }
    public function edit($id){
    	$data['editData'] = MarksGrade::find($id);
    	return view('backend.marks.add-marks-grade',$data);
    }
